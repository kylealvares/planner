...
const Shell = () => {
    ...
    const tasks = localStorage.getItem('plannerTasks') ?
        JSON.parse(localStorage.getItem('plannerTasks')).length : 0;
    const activities = 7;
    ...
    return (
        <div className="shell-container">
            <div className="shell">
                <Link to="/tasks" className={link === '/tasks' ? 'selected' : ''} >
                    <div>
                ...
                <Link to="/" className={link === '/dashboard' ? 'selected' : ''} >
                    <div>
            ...
            <div className="shell-bottom">
                ...
                <div className="account">
                    <img src="https://pbs.twimg.com/media/EbNX_erVcAUlwIx.jpg" alt="profile picture" />
                    <div>
